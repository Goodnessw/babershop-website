...
$stmt_web_settings->execute(); $web_settings = $stmt_web_settings->fetchAll();
$barber_name = ""; $barber_email = ""; $barber_address = ""; $barber_phonenumber
= ""; $opening_hours = ""; foreach ($web_settings as $option) {
if($option['option_name'] == 'barber_name') { $barber_name =
$option['option_value']; } elseif($option['option_name'] == 'barber_email') {
$barber_email = $option['option_value']; } elseif($option['option_name'] ==
'barber_phonenumber') { $barber_phonenumber = $option['option_value']; }
elseif($option['option_name'] == 'barber_address') { $barber_address =
$option['option_value']; } elseif($option['option_name'] == 'opening_hours') {
  ...
  <div class="home-section-content">
    <div id="home-section-carousel" class="carousel slide" data-ride="carousel">
      <ol class="carousel-indicators">
        <li
          data-target="#home-section-carousel"
          data-slide-to="0"
          class="active"
        ></li>
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <img
            class="d-block w-100"
            src="Design/Images/barbershop_image_1..jpg"
            alt="First slide"
          />
        ...
        <div class="carousel-item">
          <img
            class="d-block w-100"
            src="Design/Images/barbershop_image_2...jpg"
            alt="Second slide"
          />
          <div class="carousel-caption d-md-block">
            <h3>It's Not Just a Haircut, It's an Experience.</h3>
        ...
        <div class="carousel-item">
          <img
            class="d-block w-100"
            src="Design/Images/barbershop_image_3..jpg"
            alt="Third slide"
          />
          <div class="carousel-caption d-md-block">
            <h3>It's Not Just a Haircut, It's an Experience.</h3>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-1.jpg')"
          ></div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-2.jpg')"
          ></div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-3.jpg')"
          ></div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-4.jpg')"
          ></div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-5.jpg')"
          ></div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-6.jpg')"
          ></div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-7.jpg')"
          ></div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 gallery-column">
        <div style="height: 230px">
          <div
            class="gallery-img"
            style="background-image: url('Design/Images/portfolio-8.jpg')"
          ></div>
        </div>
      </div>
    </div>
...
<section class="pricing_section" id="pricing">
  ...
  $stmt->execute(); $categories = $stmt->fetchAll(); ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      category_id = ?"); $stmt->execute(array($category['category_id']));
      $totalServices = $stmt->rowCount(); $services = $stmt->fetchAll();
      if($totalServices > 0) { ?>
        ...
        <div class="price_wrap">
          ...
          <ul class="price_list">
            ...
            <li>
              ...
              <span class="price"
                >$<?php echo $service['service_price'] ?></span
              >
            </li>
      ...
      <div class="col-lg-6 sm-padding">
        <div class="contact-form">
          <div id="contact_ajax_form" class="contactForm">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                <button id="contact_send" class="default_btn">
                  Send Message
                </button>
              </div>
            </div>
            <img
              src="Design/Images/ajax_loader_gif.gif"
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="footer_widget">
          <h3>Headquarters</h3>
          <p>
            <?php echo $barber_address; ?>
          </p>
          <p>
            <?php echo $barber_email; ?>
            <br />
            <?php echo $barber_phonenumber; ?>
          </p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6">
