...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8">
	  	...
	  	<meta name="author" content="Djt Academy">

  		<title><?php echo $pageTitle ?></title>
	<?php 
	 $id =$_SESSION['admin_id_barbershop_Xw211qAAsq4'];
	 $sql = $con->prepare("SELECT * FROM `barber_admin` WHERE `admin_id`= '$id'");
	 $sql->execute();
	 $fetch = $sql->fetch();
	?>
  		<!-- FONTS FILE -->
		...
		<!-- Favicon -->
		 <link rel="shortcut icon" href="Design/images/barber-icon.jpg" type="image/x-icon">
	</head>
  		...
  		<div id="wrapper">
			...
			.bg-gradient-primary{
				background:navy !important;
			  	...
			  	<div id="content">
					<?php  $id = $_SESSION['admin_id_barbershop_Xw211qAAsq4'];
    $sql = $con->prepare("SELECT * FROM `barber_admin` WHERE `admin_id`= '$id' ");
    $sql->execute();
    $fetch = $sql->fetch();
    if($fetch == 0){
    ...
    $greeting = "Good Evening";
					...
					<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					 	...
					 	<!-- Sidebar Toggle (Topbar) -->
						  ...
						  <center><h4 class="welcomemssg"><?php echo "$greeting ". $fetch['full_name']?></h4></center>
					  	<!-- Topbar Navbar -->
